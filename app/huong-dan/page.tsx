              ...
              <div className="space-y-4">
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-co-ban/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Cơ bản
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-to-doi/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Tổ đội
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-luyen-cong/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Luyện công
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-phuc-hoi/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Phục hồi
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-hanh-trang/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Hành trang
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-doi-thu/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Đối thủ
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-chien-dau/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Chiến đấu
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-tu-ve-pk/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Tự vệ/PK
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-tien-ich/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Tiện ích
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/tab-dang-nhap/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Tab Đăng nhập
                    </Link>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 text-xl font-semibold">
                    <Link
                      href="/huong-dan/sandboxie-proxy/cach-cau-hinh"
                      className="text-primary hover:underline"
                    >
                      Sandboxie & Proxy
                    </Link>
